...
const STEPS = [
  {
    number: "01",
    day: "5 June 2026",
    date: "Workshop Commencement",
    phase: "Joining & Onboarding",
    desc: "The workshop officially begins. Participants receive joining instructions, community access, and program details.",
  },
  {
    number: "02",
    day: "5 – 20 June 2026",
    date: "15 Days Program",
    phase: "Training Sessions",
    desc: "Daily 2-hour live evening sessions covering your selected domain through practical learning and mentor guidance.",
  },
  {
    number: "03",
    day: "Throughout Program",
    date: "Assignments & Activities",
    phase: "Practical Learning",
    desc: "Participants complete assignments, tasks, and practical exercises designed to build industry-relevant skills.",
  },
  {
    number: "04",
    day: "Final Evaluation",
    date: "Test + Project Review",
    phase: "Assessment",
    desc: "Participants undergo a test, project evaluation, and assignment review based on their selected domain.",
  },
  {
    number: "05",
    day: "Post Workshop",
    date: "Opportunities & Growth",
    phase: "Internship / PPO",
    desc: "1st & 2nd Year students become eligible for internship opportunities. 3rd Year students become eligible for internship and PPO opportunities based on performance.",
  },
  {
    number: "06",
    day: "Mentor Connect",
    date: "Details Shared Soon",
    phase: "Mentor Profiles",
    desc: "Detailed mentor profiles and session information will be shared with all registered participants shortly after enrollment.",
  },
];
